    ...
    <div class="container-fluid p-0">
      <div class="row no-gutters">
        ...
        <div class="col-lg-4 col-sm-6 text-center">
          <a class="portfolio-box" href="img/portfolio/fullsize/1.jpg">
            <img class="img-fluid" src="<?=base_url('assets/img/electrical7.jpg'); ?>"width="100%">
            <div class="portfolio-box-caption">
              <div class="project-category text-white-50">
                Category
              </div>
        ...
        <div class="col-lg-4 col-sm-6">
          <a class="portfolio-box" href="prg.jpg">
            <img class="img-fluid" src="<?=base_url('assets/img/it2.jpg'); ?>" alt="">
            <div class="portfolio-box-caption">
              <div class="project-category text-white-50">
                Category
              </div>
        ...
        <div class="col-lg-4 col-sm-6 text-center">
          <a class="portfolio-box" href="">
            <img class="" src="<?=base_url('assets/img/electrical4.jpg'); ?>" width="100%" height="254">
            <div class="portfolio-box-caption">
              <div class="project-category text-white-50">
                Category
              </div>
